...
export function Settings() {
  ...
  const groqConfigComponent = accessStore.provider === ServiceProvider.Groq && (
    <>
      <ListItem
        title={"dud"}
        subTitle={"Locale.Settings.Access.OpenAI.Endpoint.fffffSubTitle"}
      >
        <input
          type="text"
      ...
      >
        <PasswordInput
          ...
          type="text"
          placeholder={Locale.Settings.Access.Groq.ApiKey.Placeholder}
          onChange={(e) => {
            accessStore.update(
