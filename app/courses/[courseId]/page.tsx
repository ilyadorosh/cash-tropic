    ...
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: content.text
          .replace(
            /^### (.+)$/gm,
            '<h3 style="margin: 24px 0 12px; font-size: 1.1rem;">$1</h3>',
          )
          .replace(
            /^## (.+)$/gm,
            '<h2 style="margin: 32px 0 16px; font-size: 1.3rem;">$1</h2>',
          )
          .replace(/\*\*(.+?)\*\*/g, "<strong>$1</strong>")
          .replace(
            /`([^`]+)`/g,
            '<code style="background: var(--gray); padding: 2px 6px; border-radius: 4px; font-size: 0.9em;">$1</code>',
          )
          .replace(
            /```(\w+)?\n([\s\S]*?)```/g,
            '<pre style="background: var(--gray); padding: 16px; border-radius: 8px; overflow-x: auto; margin: 16px 0;"><code>$2</code></pre>',
          )
          .replace(/\n- /g, "\n• ")
        ...
        <div style={{ marginBottom: "30px" }}>
          ...
          >
            ...
            <div>
              ...
              <p
                style={{ margin: "0 0 12px", opacity: 0.7, fontSize: "1.1rem" }}
              >
                {course.description}
              </p>
              <div
            ...
            >
              ...
              <div
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, var(--primary) 0%, var(--second) 100%)",
                  color: "white",
                }}
              >
                      ...
                      {(lesson.type === "challenge" ||
                        ...
                        <div>
                          <p style={{ fontStyle: "italic", opacity: 0.7 }}>
                            🎯 Interaktive {lessonTypeLabels[lesson.type]} -
                            Öffne den Kurs im Lernmodus für volle
                            Funktionalität.
                          </p>
                          <pre
                            style={{
