...
import { ModelProvider, OpenaiPath, GroqPath } from "@/app/constant";
...
async function handle(
  ...
  console.log("[Groq? Route] params ", params);
  ...
  if (!extended_ALLOWD_PATH_Set.has(subpath)) {
    console.log("[Groq? Route] forbidden path ", subpath);
  ...
  const authResult = auth(req, ModelProvider.Groq);
  if (authResult.error) {
