      ...
      >
        ...
        >
          ...
          >
            <div style={{ fontSize: "2rem", fontWeight: "700" }}>
              {
                usersWithData.filter(
                  (u) =>
                    u.courseData &&
                    Object.keys(u.courseData.courses).length > 0,
                ).length
              }
            </div>
          ...
          >
            <div style={{ fontSize: "2rem", fontWeight: "700" }}>
              {usersWithData.reduce(
                (sum, u) => sum + (u.courseData?.totalPoints || 0),
                0,
              )}
            </div>
            ...
            >
              ...
              >
                ...
                {user.courseData && (
                  ...
                  >
                    <span>
                      📚 {Object.keys(user.courseData.courses).length} Kurse
                    </span>
                    <span>
                      🏆 {user.courseData.achievements.length} Erfolge
                    </span>
