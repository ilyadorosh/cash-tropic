  ...
  const drawGrid = useCallback(() => {
    ...
    gridRef.current.forEach((row, i) => {
      row.forEach((cell, j) => {
        ...
        ctx.fillStyle = `rgb(${Math.floor(118 * cell)}, ${Math.floor(
          185 * cell,
  ...
  return (
    <div className={styles.ncaContainer}>
      ...
      <p className={styles.description}>
        An interactive simulation of Neural Cellular Automata - a blend of
        classical cellular automata and neural network-inspired growth patterns.
        Click on the canvas to add energy to cells.
      </p>
      ...
      <div className={styles.info}>
        ...
        <p>
          Neural Cellular Automata (NCA) combine the local interaction patterns
          of classical cellular automata with continuous state spaces and
          learning-inspired update rules.
        </p>
        <ul>
          <li>
            Each cell has a continuous state between 0 (dead) and 1 (fully
            alive)
          </li>
          <li>
            Cells interact with their 8 neighbors using growth and decay rules
          </li>
        ...
        <p className={styles.inspiration}>
          Inspired by research in differentiable cellular automata and
          self-organizing systems. Learn more at{" "}
          <a
